...
class PriceRejectedNotification extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Price Revision Rejected - #' . $this->booking->id,
        );
    }
    ...
    {
        return new Content(
            view: 'emails.booking.price-rejected',
            with: [
