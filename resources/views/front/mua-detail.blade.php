                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" id="bk_time">
                                            ...
                                            @if (!empty($timeSlots))
                                                ...
                                                @endforeach
                                            @else
                                                <option value="" disabled>No available times today</option>
                                            @endif
                                        </select>
                                        @if (!empty($unavailableSlots))
                                            <small class="text-muted mt-1 d-block">
                                                <i class="fas fa-info-circle me-1"></i>
                                                Some time slots are unavailable due to external bookings
                                            </small>
                                        @endif
                                    </div>
                                </div>
                                        ...
                                        @endphp
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input service-checkbox" type="checkbox"
                                                    ...
                                                    <!-- DEBUG: feature={{ $feature['name'] }}, is_image={{ $feature['is_image'] ?? 'NULL' }, result={{ ($feature['is_image'] ?? '') == 'on' ? 'true' : 'false' }} -->
