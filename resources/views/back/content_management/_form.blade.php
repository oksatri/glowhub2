                            ...
                            <div class="row gx-4">
                                <div class="col-lg-8">
                                    ...
                                    <div class="row gx-2">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select name="status"
                                                ...
                                                <option value="draft"
                                                    {{ old('status', $content->status ?? '') == 'draft' ? 'selected' : '' }}>
                                                    Draft</option>
                                                <option value="publish"
                                                    {{ old('status', $content->status ?? '') == 'publish' ? 'selected' : '' }}>
                                                    Publish</option>
                                                <option value="archive"
                                                    {{ old('status', $content->status ?? '') == 'archive' ? 'selected' : '' }}>
                                                    Archive</option>
                                            </select>
                                            @if ($errors->has('status'))
                                                <div class="invalid-feedback d-block">{{ $errors->first('status') }}
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="mb-3 form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="has_button"
                                            name="has_button" value="1"
                                    ...
                                    <div id="buttons-area"
                                        ...
                                        <div class="mb-3 d-flex gap-2 align-items-center">
                                            ...
                                            <input type="number" id="buttons_count" name="buttons_count"
                                                class="form-control w-auto ms-2" value="{{ old('buttons_count', 0) }}"
                                                min="0">
                                ...
                                <div class="col-lg-4">
                                    <div class="card border-0 shadow-sm">
                                        <div class="card-body">
                                            <h6 class="card-title" style="color:#111827; font-weight:600;">Meta &
                                                Image</h6>
                                            <p class="text-muted small">Upload image and optional metadata for this
                                                section.</p>
