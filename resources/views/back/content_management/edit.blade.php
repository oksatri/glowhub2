                    ...
                    <div class="col-lg-8">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="section_type"
                                    ...
                                    <option value="product"
                                        {{ old('section_type', $content->section_type) == 'product' ? 'selected' : '' }}>
                                        Product</option>
                                    <option value="testimonials"
                                        {{ old('section_type', $content->section_type) == 'testimonials' ? 'selected' : '' }}>
                                        Testimonials</option>
                                    <option value="contact"
                                        {{ old('section_type', $content->section_type) == 'contact' ? 'selected' : '' }}>
                                        Contact</option>
                                    <option value="hero"
                                        {{ old('section_type', $content->section_type) == 'hero' ? 'selected' : '' }}>Hero
                                    </option>
                                </select>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="status"
                                    ...
                                    <option value="publish"
                                        {{ old('status', $content->status) == 'publish' ? 'selected' : '' }}>Publish
                                    </option>
                                    <option value="archive"
                                        {{ old('status', $content->status) == 'archive' ? 'selected' : '' }}>Archive
                                    </option>
                                </select>
                        ...
                        <div class="mb-3 form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="has_button" name="has_button" value="1"
                                {{ old('has_button', $content->has_button) ? 'checked' : '' }}>
                            <label class="form-check-label" for="has_button">Include buttons (CTA)</label>
                        </div>

                        <div id="buttons-area"
                            style="display: {{ old('has_button', $content->has_button) ? 'block' : 'none' }};">
                            ...
                            <div id="buttons-list" class="mb-3">
                                <!-- existing buttons -->
                                @php $existingButtons = old('buttons', $content->buttons ?? []); @endphp
                                @if ($existingButtons)
                                    @foreach ($existingButtons as $i => $b)
