...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ url('content-management/create') }}" class="btn px-4 py-2 rounded-pill shadow-sm text-white"
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-lg-5 col-md-6">
                        <div class="input-group input-group-lg">
                            ...
                            <input type="text" name="title" class="form-control border-0 ps-2 shadow-none"
                                style="background: white; font-size: 0.95rem;" placeholder="Search content..."
                                value="{{ request('title') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6">
                        <select name="section_type" class="form-select shadow-none border-0"
                            ...
                            <option value="content" {{ request('section_type') == 'content' ? 'selected' : '' }}>Content
                                Section</option>
                            <option value="hero" {{ request('section_type') == 'hero' ? 'selected' : '' }}>Hero Banner
                            </option>
                            <option value="product" {{ request('section_type') == 'product' ? 'selected' : '' }}>Product
                            </option>
                            <option value="testimonials" {{ request('section_type') == 'testimonials' ? 'selected' : '' }}>
                                Testimonials</option>
                        </select>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6">
                        <select name="status" class="form-select shadow-none border-0"
                            ...
                            <option value="archive" {{ request('status') == 'archive' ? 'selected' : '' }}>Archived
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex gap-2">
                        ...
                        @if (request()->hasAny(['title', 'section_type', 'status']))
                            <a href="{{ url('content-management') }}" class="btn py-2 px-3"
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" style="border-collapse: separate; border-spacing: 0;">
                    <thead style="background: #F8FAFC;">
                        <tr>
                            <th class="px-4 py-3"
                                style="color: #1F2937; font-weight: 600; border-bottom: 2px solid #E5E7EB;">Content Details
                            </th>
                            <th class="py-3"
                                style="width: 150px; color: #1F2937; font-weight: 600; border-bottom: 2px solid #E5E7EB;">
                                Type</th>
                            <th class="py-3"
                            ...
                            <tr style="border-bottom: 1px solid #F3F4F6;">
                                    ...
                                    <div class="d-flex align-items-center py-1">
                                        <div class="content-icon me-3 rounded-lg d-flex align-items-center justify-content-center"
                                            ...
                                            @switch($content->section_type)
                                                @case('hero')
                                                    <i class="fas fa-star"
                                                        style="color: #FBBF24 !important; font-size: 2.25rem;"></i>
                                                @break

                                                @case('product')
                                                    <i class="fas fa-box"
                                                        style="color: #3B82F6 !important; font-size: 2.25rem;"></i>
                                                @break

                                                @case('testimonials')
                                                    <i class="fas fa-quote-right"
                                                        style="color: #10B981 !important; font-size: 2.25rem;"></i>
                                                @break
                                                ...
                                                @default
                                                    <i class="fas fa-file-alt"
                                                        style="color: #60A5FA !important; font-size: 2.25rem;"></i>
                                            @endswitch
                                        </div>
                                        <div>
                                            <h6 class="mb-1"
                                            ...
                                            <p class="mb-0" style="color: #6B7280; font-size: 0.875rem;">
                                                {{ Str::limit($content->description, 50) }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td style="vertical-align: middle;">
                                    <span class="text-capitalize"
                                        style="color: #374151; font-weight: 500;">{{ $content->section_type }}</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <span
                                            style="color: #374151; font-size: 0.875rem; font-weight: 500;">{{ $content->updated_at->format('M d, Y') }}</span>
                                        <span
                                            style="color: #6B7280; font-size: 0.813rem;">{{ $content->updated_at->format('h:i A') }}</span>
                                    </div>
                                </td>
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-16">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <h5 class="fw-normal mb-2" style="color: #374151; font-size: 1.25rem;">No Content
                                                Found</h5>
