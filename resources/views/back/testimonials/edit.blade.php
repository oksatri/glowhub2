                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name"
                                ...
                                placeholder="Person name" value="{{ old('name', $t->name) }}" required>
                            @if ($errors->has('name'))
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="role"
                                ...
                                placeholder="e.g. Bride, Corporate Event" value="{{ old('role', $t->role) }}">
                        </div>
                        ...
                        <div class="row gx-2">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="status" class="form-select {{ $errors->has('status') ? 'is-invalid' : '' }}">
                                    <option value="publish" {{ old('status', $t->status) == 'publish' ? 'selected' : '' }}>
                                        Publish</option>
                                    <option value="draft" {{ old('status', $t->status) == 'draft' ? 'selected' : '' }}>
                                        Draft</option>
                                    <option value="archive" {{ old('status', $t->status) == 'archive' ? 'selected' : '' }}>
                                        Archive</option>
                                </select>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="quote" rows="4" class="form-control {{ $errors->has('quote') ? 'is-invalid' : '' }}"
                                placeholder="The testimonial text...">{{ old('quote', $t->quote) }}</textarea>
                            @if ($errors->has('quote'))
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($t->image)
                                        <div class="mt-2"><img src="{{ asset('storage/' . $t->image) }}" width="120"
                                                alt=""></div>
                                    @endif
                                </div>
