...
@section('page-subtitle', 'Add new service to your offerings')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon"
                                name="icon" value="{{ old('icon') }}" placeholder="e.g., fas fa-laptop-code">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Optional. Supported formats: JPEG, PNG, JPG, GIF. Max size:
                                2MB</small>
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
